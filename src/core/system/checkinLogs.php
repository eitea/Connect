...
<table class="table table-hover">
    ...
    <tbody>
        <?php
        $result = $conn->query("SELECT firstname, lastname, remoteAddr, userAgent, time FROM checkinLogs LEFT JOIN logs ON indexIM = timestampID LEFT JOIN UserData ON userID = UserData.id");
        echo $conn->error;
