...
<ul class="nav nav-tabs">
    <li <?php if ($activeTab == 'project') {
    echo 'class="active"';
} ?>><a data-toggle="tab" href="#project" onclick="$('#sav').val('project');"><?php echo $lang['VIEW_PROJECTS']; ?></a></li>
    <li <?php if ($activeTab == 'home') {
    echo 'class="active"';
} ?>><a data-toggle="tab" href="#home" onclick="$('#sav').val('home');"><?php echo $lang['RECORD']; ?></a></li>
    <li <?php if ($activeTab == 'taxes') {
    echo 'class="active"';
} ?>><a data-toggle="tab" href="#menuTaxes" onclick="$('#sav').val('taxes');"><?php echo $lang['TAXES']; ?></a></li>
    <li <?php if ($activeTab == 'banking') {
    echo 'class="active"';
} ?>><a data-toggle="tab" href="#menuBank" onclick="$('#sav').val('banking');">Banking</a></li>
    <li <?php if ($activeTab == 'billing') {
    echo 'class="active"';
} ?>><a data-toggle="tab" href="#menuBilling" onclick="$('#sav').val('billing');"><?php echo $lang['BILLING']; ?></a></li>
    <li <?php if ($activeTab == 'payment') {
    echo 'class="active"';
} ?>><a data-toggle="tab" href="#menuPayment" onclick="$('#sav').val('payment');"><?php echo $lang['PAYMENT']; ?></a></li>
    <li <?php if ($activeTab == 'notes') {
    echo 'class="active"';
} ?>><a data-toggle="tab" href="#menuContact" onclick="$('#sav').val('notes');"><?php echo $lang['NOTES']; ?></a></li>
    <li <?php if ($activeTab == 'docs') {
    echo 'class="active"';
} ?>><a data-toggle="tab" href="#menuDocs" onclick="$('#sav').val('docs');"><?php echo $lang['DOCUMENTS']; ?></a></li>
</ul>

<form id="mainForm" method="POST">
    <div class="tab-content">
        <div id="project" class="tab-pane fade <?php if ($activeTab == 'project') {
    echo 'in active';
...
<form method="POST" >
    <div id="menuTaxes" class="tab-pane fade <?php if ($activeTab == 'taxes') {
                                    echo 'in active';
                                } ?>">
        <div class="row checkbox">
    ...
    <div id="menuBank" class="tab-pane fade <?php if ($activeTab == 'banking') {
                    echo 'in active';
                } ?>">
        <div class="row form-group">
            <h3>
...
<?php echo $modals; ?>
    ...
    <div id="menuBilling" class="tab-pane fade <?php if ($activeTab == 'billing') {
                        echo 'in active';
                    } ?>">
        <div class="row checkbox">
            <div class="col-sm-9">
        ...
        <div class="row form-group">
            ...
            <div class="col-sm-3">
                <select name="billDelivery" class="js-example-basic-single">
                    <option <?php
                    if ($row['billDelivery'] == 'Fax') {
                        echo 'selected';
                    }
?> value="Fax">Fax</option>
                    <option <?php
                    if ($row['billDelivery'] == 'Post') {
                        echo 'selected';
                    }
?> value="Post">Post</option>
                    <option <?php
                    if ($row['billDelivery'] == 'E-Mail') {
                        echo 'selected';
                    }
?> value="E-Mail">E-Mail</option>
    ...
    <div id="menuPayment" class="tab-pane fade <?php if ($activeTab == 'payment') {
                        echo 'in active';
                    } ?>">
        <h3>Zahlungsdaten</h3>
        <hr>
...
?>
    ...
    <div id="menuContact" class="tab-pane fade <?php if ($activeTab == 'notes') {
                    echo 'in active';
                } ?>">
        <h3>Bemerkungen</h3>
        <hr>
    ...
    <div id="menuDocs" class="tab-pane fade <?php if ($activeTab == 'docs') {
                    echo 'in active';
                } ?>">
