...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    SELECT userID, mon, tue, wed, thu, fri, sat, sun, vacPerYear, overTimeLump, pauseAfterHours, hoursOfRest, startDate, endDate FROM $intervalTable WHERE userID = $x";
        if (!$conn->query($sql)) {
            $acc = false;
            echo '<br>dataErr: ' . mysqli_error($conn);
        }
  ...
  WHERE endDate IS NULL ORDER BY $userTable.id ASC";
    ...
    if ($result && $result->num_rows > 0) {
        ...
        <?php echo $lang['GENDER']; ?>:
                                ...
                                <div class="col-md-2">
                                    <label>
                                        <input type="radio" name="gender<?php echo $x; ?>" value="female" <?php if ($gender == 'female') {
            echo 'checked';
        } ?> ><i class="fa fa-venus"></i><?php echo $lang['GENDER_TOSTRING']['female']; ?> <br>
                                    </label>
                                </div>
                                <div class="col-md-8">
                                    <label>
                                        <input type="radio" name="gender<?php echo $x; ?>" value="male" <?php if ($gender == 'male') {
            echo 'checked';
        } ?> ><i class="fa fa-mars"></i><?php echo $lang['GENDER_TOSTRING']['male']; ?>
                                    </label>
                                </div>
                            </div>
                            <div class="container-fluid">
        ...
        <?php echo $lang['ADMIN_MODULES']; ?>: <br>
                                    <div class="checkbox">
                                        <div class="col-md-6">
                                            <label>
                                                <input type="checkbox" name="isCoreAdmin<?php echo $x; ?>" <?php if ($isCoreAdmin == 'TRUE') {
            echo 'checked';
        } ?>><?php echo $lang['ADMIN_CORE_OPTIONS']; ?>
                                            </label><br>
                                            <label>
                                                <input type="checkbox" name="isTimeAdmin<?php echo $x; ?>" <?php if ($isTimeAdmin == 'TRUE') {
            echo 'checked';
        } ?>><?php echo $lang['ADMIN_TIME_OPTIONS']; ?>
                                            </label><br>
                                            <label>
                                                <input type="checkbox" name="isProjectAdmin<?php echo $x; ?>" <?php if ($isProjectAdmin == 'TRUE') {
            echo 'checked';
        } ?> /><?php echo $lang['ADMIN_PROJECT_OPTIONS']; ?>
                                            </label><br>
                                            <label>
                                                <input type="checkbox" name="isReportAdmin<?php echo $x; ?>" <?php if ($isReportAdmin == 'TRUE') {
            echo 'checked';
                                        ...
                                        <div class="col-md-6">
                                            <label>
                                                <input type="checkbox" name="isERPAdmin<?php echo $x; ?>" <?php if ($isERPAdmin == 'TRUE') {
            echo 'checked';
        } ?> />ERP
                                            </label><br>
                                            <label>
                                                <input type="checkbox" name="isDynamicProjectsAdmin<?php echo $x; ?>" <?php if ($isDynamicProjectsAdmin == 'TRUE') {
            echo 'checked';
        } ?>><?php echo $lang['DYNAMIC_PROJECTS']; ?>
                                            </label><br>
                                            <label>
                                                <input type="checkbox" name="isFinanceAdmin<?php echo $x; ?>" <?php if ($isFinanceAdmin == 'TRUE') {
                                    echo 'checked';
                                } ?> /><?php echo $lang['FINANCES']; ?>
                                            </label><br>
                                            <label>
                                                <input type="checkbox" name="isDSGVOAdmin<?php echo $x; ?>" <?php if ($isDSGVOAdmin == 'TRUE') {
                                    echo 'checked';
                                } ?> />DSGVO
                                            </label>
                                        </div>
        ...
        <?php echo $lang['USER_MODULES']; ?>:
                                    <div class="checkbox">
                                        <div class="col-md-6">
                                            <label>
                                                <input type="checkbox" name="canStamp<?php echo $x; ?>" <?php if ($canStamp == 'TRUE') {
            echo 'checked';
        } ?>><?php echo $lang['CAN_CHECKIN']; ?>
                                            </label>
                                            <br>
                                            <label>
                                                <input type="checkbox" name="canBook<?php echo $x; ?>" <?php if ($canBook == 'TRUE') {
                                    echo 'checked';
                                } ?> /><?php echo $lang['CAN_BOOK']; ?>
                                            </label>
                                            <br>
                                            <label>
                                                <input type="checkbox" name="canEditTemplates<?php echo $x; ?>" <?php if ($canEditTemplates == 'TRUE') {
                                    echo 'checked';
                                } ?> /><?php echo $lang['CAN_EDIT_TEMPLATES']; ?>
                                            </label>
                                            <br>
                                            <label>
                                                <input type="checkbox" name="canUseSocialMedia<?php echo $x; ?>" <?php if ($canUseSocialMedia == 'TRUE') {
                                    echo 'checked';
                                } ?> /><?php echo $lang['CAN_USE_SOCIAL_MEDIA']; ?>
                                            </label>
                                        </div>
                                        <div class="col-md-6">
                                            <label>
                                                <input type="checkbox" name="canCreateTasks<?php echo $x; ?>" <?php if ($canCreateTasks == 'TRUE') {
                                    echo 'checked';
                                } ?>/><?php echo $lang['CAN_CREATE_TASKS']; ?>
                                            </label>
                                        </div>
                                    </div>
                                </div>
