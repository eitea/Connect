...
<tbody>
    ...
    if ($result && $result->num_rows > 0) {
        ...
        <script>setInterval(function () {
                updateSocialBadge("#badge<?php echo $x; ?>", <?php echo $x; ?>)
            }, 10000)</script>
        <!-- chat modal -->
...
<tbody>
    ...
    if ($result && $result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            ?>
        <script>setInterval(function () {
                updateGroupSocialBadge("#groupbadge<?php echo $x; ?>", <?php echo $x; ?>)}, 10000)</script>
        <!-- group chat modal -->
                            ...
                            <div class="modal-body">
                                ...
                                <div class="checkbox">
                                    ...
                                    while ($row = $user_result->fetch_assoc()) {
                                        ...
                                        ?>
                                        <label>
                                            <input type="checkbox" value="<?php echo $_x; ?>" <?php if ($_x == $userID) {
...
while ($row = $result->fetch_assoc()) {
    ...
    ?>
                            <label>
                                <input type="checkbox" value="<?php echo $x; ?>" <?php if ($x == $userID) {
        echo "checked disabled";
    } else {
        echo ' name="members[]" ';
    } ?>><?php echo $name ?><br>
