...
<form method=post>
    ...
    <div class="container-fluid">
        ...
        <div class="checkbox col-md-12">
            <input <?php if ($rowGitHubTable['sslVerify'] == 'TRUE') {
    echo 'checked';
} ?> type='checkbox' name='ssl' value='TRUE'>
    ...
    <div class="container-fluid">
        <br>
        <div class="checkbox col-md-12">
            <input <?php if ($rowConfigTable['enableReadyCheck'] == 'TRUE') {
    echo 'checked';
} ?> type='checkbox' name='enableReadyCheck' value='TRUE'>
    ...
    <div class="container-fluid">
        ...
        <div class="checkbox col-md-12">
            <label>
                <input <?php if (isset($rowModuleTable['endpoint'])) {
    echo "checked ";
} ?> data-toggle='modal' data-target='#s3Input'  onChange="showS3Input(event)" type='checkbox' name='enableS3Archive' value='TRUE'>
                S3 Archive
            </label>
        </div>
        <br>
    ...
    <div class="container-fluid">
        <br>
        <div class="checkbox col-md-12">
            <input <?php if ($rowConfigTable['enableReg'] == 'TRUE') {
    echo 'checked';
} ?> type='checkbox' name='enableReg' value='TRUE'>
...
<?php
if (!isset($rowModuleTable['endpoint'])) {
