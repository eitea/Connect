...
<tbody>
    ...
    while ($result && ($row = $result->fetch_assoc())):
        ...
        <tr>
            ...
            <td style="background-color:#f2f4f5"><?php if (!empty($row['identifier'])) {
            echo $row['identifier'];
        } ?></td>
...
<form method="POST" autocomplete="off">
    <div class="row">
        <div class="col-md-3">
            <input type="text" class="form-control required-field datepicker" placeholder="YYYY-MM-DD" onkeydown='if (event.keyCode == 13)
                        return false;' name="addDate" value="<?php echo substr(getCurrentTimestamp(), 0, 10); ?>">
        </div>
        <div class="col-md-3">
            <div class="input-group">
                <input type="time"  class="form-control required-field timepicker" placeholder="00:00" onkeydown='if (event.keyCode == 13)
                            return false;' name="addTimeStart" />
                <span class="input-group-addon"> - </span>
                <input type="time" class="form-control required-field timepicker" placeholder="00:00" onkeydown='if (event.keyCode == 13)
                            return false;' name="addTimeEnd" />
            </div>
        </div>
        <div class="col-md-5">
            <div class="input-group">
