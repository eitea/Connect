...
if($result && ($row = $result->fetch_assoc())) { //checkout
	...
	if($hasActiveBooking){
		$buttonEmoji .= '<button type="submit" formaction="../dynamic-projects/view" name="open" value="'.$result->fetch_assoc()['dynamicID']
			.'" class="btn btn-link btn-sm clock-counter pull-left">Task läuft</button>';
	}
} else {
