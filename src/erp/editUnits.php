...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['save'])) {
        ...
        if ($conn->error) {
            ...
            echo '<div class="alert alert-success"><a href="#" data-dismiss="alert">&times;</a>' . $lang['OK_SAVE'] . '</div>';
        }
        ...
        if ($conn->error) {
            ...
            echo '<div class="alert alert-success"><a href="#" data-dismiss="alert">&times;</a>' . $lang['OK_ADD'] . '</div>';
        }
