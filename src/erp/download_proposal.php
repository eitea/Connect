...
if (280 - $pdf->GetY() < 30) {
    $pdf->AddPage();
} //if writable space is less than 3cm: new page
//Summary
$pdf->SetFontSize(8);
$col1 = "Warenwert";
...
if ($payment_name)
    $pdf->Cell(0, 4, iconv('UTF-8', 'windows-1252', $payment_name), 0, 1);
if ($payment_1)
    $pdf->Cell(0, 5, $payment_1 . ' EUR', 0, 1);
if ($payment_2)
    $pdf->Cell(0, 5, $payment_2 . ' EUR', 0, 1);
if ($payment_3)
    $pdf->Cell(0, 5, $payment_3 . ' EUR', 0, 1);
