...
$scale = 0;
if (isset($filterings['date']) || isset($filterings['logs'])) {
    $scale++;
}
if (isset($filterings['user']) || isset($filterings['users'])) {
    $scale++;
}
if (isset($filterings['company'])) {
    $scale++;
}
if (isset($filterings['procedures'])) {
    $scale++;
}
if (isset($filterings['tasks'])) {
    $scale++;
}
$styles = array(20, 90);
            ...
            <div class="container-fluid"><br>
                ...
                <div class="filter_column">
                    ...
                    if (isset($filterings['user'])) {
                        ...
                        while ($result_fc && ($row_fc = $result_fc->fetch_assoc())) {
                            $selected = '';
                            if (in_array($row_fc['id'], $filterings['users'])) {
                                $selected = 'selected';
                            }
...
<?php if (isset($filterings['bookings'])): ?>
                        ...
                        <select name="searchCharged" class="js-example-basic-single">
                            <option value='0' <?php if ($filterings['bookings'][0] == '0') {
        echo 'selected';
    } ?> >...</option>
                            <option value='1' <?php if ($filterings['bookings'][0] == '1') {
                            echo 'selected';
                        } ?> ><?php echo $lang['NOT_CHARGED']; ?></option>
                            <option value='2' <?php if ($filterings['bookings'][0] == '2') {
                            echo 'selected';
                        } ?> ><?php echo $lang['CHARGED']; ?></option>
                        </select>
    <?php if ($filterings['bookings'][0] != 1) {
        echo '<small>*' . $lang['INFO_CHARGED'] . '</small>';
    } ?>
                        <div class="checkbox">
...
<?php if (isset($filterings['acceptance'])): ?>
                        ...
                        <select name="searchAcceptance" class="js-example-basic-single">
                            ...
                            <option value="0" <?php if ($filterings['acceptance'] == '0') {
        echo 'selected';
    } ?>><?php echo $lang['REQUESTSTATUS_TOSTRING'][0]; ?></option>
                            <option value="1" <?php if ($filterings['acceptance'] == '1') {
        echo 'selected';
    } ?>><?php echo $lang['REQUESTSTATUS_TOSTRING'][1]; ?></option>
                            <option value="2" <?php if ($filterings['acceptance'] == '2') {
                        echo 'selected';
                    } ?>><?php echo $lang['REQUESTSTATUS_TOSTRING'][2]; ?></option>
                        </select>
                        <?php endif; ?>
...
<?php if (isset($filterings['employees'])): ?>
    ...
    while ($row = $result->fetch_assoc()) {
        $modal_options .= '<option value="' . $row['id'] . '" data-icon="user">' . $row['firstname'] . ' ' . $row['lastname'] . '</option>';
    }
    ...
    <?php endif; ?>
                            ...
                            <select name="searchActivity" class="js-example-basic-single">
                                <option value="0"><?php echo $lang['DISPLAY_ALL']; ?></option>
                                <option value="1" <?php if ($filterings['logs'][0] == '1') {
                            echo 'selected';
                        } ?> ><?php echo $lang['VACATION']; ?></option>
                                <option value="2" <?php if ($filterings['logs'][0] == '2') {
                            echo 'selected';
                        } ?>><?php echo $lang['SPECIAL_LEAVE']; ?></option>
                                <option value="4" <?php if ($filterings['logs'][0] == '4') {
                            echo 'selected';
                        } ?>><?php echo $lang['VOCATIONAL_SCHOOL']; ?></option>
                                <option value="6" <?php if ($filterings['logs'][0] == '6') {
                    echo 'selected';
                } ?>><?php echo $lang['COMPENSATORY_TIME']; ?></option>
                            </select>
