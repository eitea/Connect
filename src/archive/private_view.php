...
<div class="page-header"><h3 id="title" ></h3>
    <div class="page-header-button-group">
        ...
        <button onblur="setTimeout(function(){document.getElementById('dropDiv').classList.remove('show');},300);" onclick="document.getElementById('dropDiv').classList.toggle('show');" type="button" class="btn btn-default" title="New..."><i class="fa fa-plus"></i><?php echo $lang['NEW'] ?><i class="fa fa-caret-down"></i></button>
        ...
        <div id="uploadBtn" class="simpleBtnWrapper"><?php if($enabled) echo
...
<script>
    ...
    function fillTable(data){
        ...
        if(data[0]){
            for(i=0;i<data[0].length;i++){
                ...
                if(isS3){rows[i].children[1].innerHTML = "<i class='fa fa-file'></i>";}else{rows[i].children[1].innerHTML = "<i class='fa fa-paperclip'></i>";}
    ...
    function anySelected(){
        isSelected = false;
        if($("#tableContent :checked").length > 0) isSelected = true;
