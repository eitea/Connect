...
include dirname(__DIR__) . '/validate.php';
...
if ($row['version'] < 100) {
    ...
    $holidayFile = dirname(__DIR__) . '/setup/Feiertage.txt';
...
if ($row['version'] < 111) {
    ...
    $file = fopen(dirname(__DIR__) . '/setup/Steuerraten.csv', 'r');
    if ($file) {
...
require dirname(__DIR__) . '/version_number.php';
