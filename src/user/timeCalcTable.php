<?php include dirname(__DIR__) . '/header.php'; enableToStamps($userID);?>
<?php
...
<div class="page-header">
  <h3><?php echo $lang['MONTHLY_REPORT']; ?><div class="page-header-button-group"><?php include dirname(__DIR__) . '/misc/set_filter.php'; ?></div></h3>
</div>
