...
echo $lang ['SAVE'];
    ...
    <div id="menuTaxes" class="tab-pane fade <?php
...
echo $row ['accountName'];
      ...
      <div class="row form-group">
        ...
        <div class="col-sm-4">
          <input type="text" class="form-control" name="taxnumber" value="<?php
...
echo $row ['taxnumber'];
        ...
        <div class="col-sm-4">
          <input type="text" class="form-control" name="vatnumber" value="<?php
...
echo $row ['vatnumber'];
      ...
      <div class="row form-group">
        ...
        <div class="col-sm-4">
          <input type="text" class="form-control" name="taxArea" value="<?php
...
echo $row ['taxArea'];
        ...
        <div class="col-sm-4">
          <input type="text" class="form-control" name="customerGroup" value="<?php
										
echo $row ['customerGroup'];
										?>" />
        </div>
      </div>
      <div class="row form-group">
    ...
    <div id="menuBank" class="tab-pane fade <?php
...
echo mc_status ();
        ...
        <div class="col-md-2">
          ...
          <button type="submit" class="btn btn-warning btn-block" name="addBankingDetail"><?php
...
echo $lang ['ADD'];
    ...
    <div id="menuBilling" class="tab-pane fade <?php
...
if ($activeTab == 'billing') {
      ...
      <div class="row checkbox">
        ...
        <br>
        <div class="col-sm-3">
          <input type="checkbox" name="eBill" <?php
...
if ($row ['eBill'] == 'true') {
      ...
      <div class="row form-group">
        ...
        <div class="col-sm-3">
          <input type="number" step="any" class="form-control" name="creditLimit" value="<?php
...
echo $row ['creditLimit'];
        ...
        <div class="col-sm-3">
          <input type="text" class="form-control datetimepicker" name="lastFaktura" value="<?php
										
echo $row ['lastFaktura'];
										?>" />
        </div>
      </div>
      <div class="row form-group">        
		...
		<div class="row form-group">
	      ...
	      <div class="col-sm-3">
	      	<input type="email" name="billingMailAddress" class="form-control" value="<?php
								
echo $row ['billingMailAddress'];
								?>" />
	      </div>
      </div>
    </div>

    <div id="menuPayment" class="tab-pane fade <?php
...
if ($activeTab == 'payment') {
      ...
      <div class="row form-group">
        ...
        <div class="col-sm-9">
          <input type="checkbox" name="warningEnabled" <?php
										
if ($row ['warningEnabled'] == 'true') {
											echo 'checked';
										}
										?> />
        </div>
      ...
      <div class="row form-group">
        ...
        <div class="col-sm-3">
          <input type="number" class="form-control" name="karenztage" value="<?php
...
echo $row ['karenztage'];
        ...
        <div class="col-sm-3">
          <input type="text" class="form-control datetimepicker" name="lastWarning" value="<?php
										
echo $row ['lastWarning'];
										?>" />
        </div>
      </div>
      <div class="row form-group">
        ...
        <div class="col-sm-3">
          <input type="number" step="0.01" class="form-control" name="warning1" value="<?php
...
echo $row ['warning1'];
      ...
      <div class="row form-group">
        ...
        <div class="col-sm-3">
          <input type="number" step="0.01" class="form-control" name="warning2" value="<?php
...
echo $row ['warning2'];
      ...
      <div class="row form-group">
        ...
        <div class="col-sm-3">
          <input type="number" step="0.01" class="form-control" name="warning3" value="<?php
...
echo $row ['warning3'];
      ...
      <div class="row form-group">
        ...
        <div class="col-md-1">
          <input type="checkbox" name="calculateInterest" <?php
										
if ($row ['calculateInterest'] == 'true') {
											echo 'checked';
										}
										?>/>
        </div>
    ...
    <div id="menuContact" class="tab-pane fade <?php
...
if ($activeTab == 'notes') {
    ...
    <div id="menuDocs" class="tab-pane fade <?php
...
while ( $row = $result_p->fetch_assoc () ) :
  ...
  <form method="post">
    <div class="modal fade editingProjectsModal-<?php
...
echo $lang ['HOURS'];
	?></label>
              <input type="number" class="form-control" step="any" name="boughtHours" value="<?php
...
echo $lang ['HOURLY_RATE'];
	?></label>
              <input type="number" class="form-control" step="any" name="pricedHours" value="<?php
	
echo $row ['hourlyPrice'];
	?>">
            </div>
          </div>
          <div class="row checkbox">
            <div class="col-md-6">
              <label><input type="checkbox" name="productive" <?php
	
echo $row ['status'];
	?> /><?php
	
echo $lang ['PRODUCTIVE'];
	?></label>
            </div>
            <div class="col-md-6">
              <br>
	...
	?>
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
          <button type="submit" class="btn btn-warning" name="save" value="<?php
...
echo $lang ['HOURLY_RATE'];
        ...
        <div class="container-fluid">
          <div class="col-md-6 checkbox">
            <input type="checkbox" name="status" value="checked" checked> <i class="fa fa-tags"></i> <?php
...
echo $lang ['PRODUCTIVE'];
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
        <button type="submit" class="btn btn-warning" name='add'> <?php
