...
<div id="loader" style="display:none"></div>
  ...
  <div class="collapse" id="infoDiv_collapse">
    <div class="well">
      <a href='http://www.eitea.at'> EI-TEA Partner GmbH </a> - <?php include dirname(__DIR__) . '/version_number.php';
            ...
            <div class="col-sm-2">
              <div class="form-group">
                <select name="type" class="js-example-basic-single btn-block">
                  ...
                  <option <?php if ($companyType == "GmbH") {
    echo "selected";
}
?> value="GmbH">GmbH</option>
                  <option <?php if ($companyType == "AG") {
    echo "selected";
}
?> value="AG">AG</option>
                  <option <?php if ($companyType == "OG") {
    echo "selected";
}
?> value="OG">OG</option>
                  <option <?php if ($companyType == "KG") {
    echo "selected";
}
?> value="KG">KG</option>
                  <option <?php if ($companyType == "EU") {
    echo "selected";
}
?> value="EU">EU</option>
                  <option <?php if ($companyType == "-") {
    echo "selected";
}
?> value="-">Sonstiges</option>
                </select>
              </div>
            </div>
          </div>
