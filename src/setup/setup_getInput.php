    ...
    <div class="col-sm-8 col-lg-4">
      <div class="form-group">
        <div class="input-group">
          ...
          <input type="text" class="form-control" name="firstname" placeholder="Firstname.." value="<?php if(isset($_POST['firstname'])) echo $_POST['firstname']; ?>" />
        </div>
      </div>
    </div>
    <div class="col-sm-8 col-lg-4">
      <div class="form-group">
        <div class="input-group">
          ...
          <input type="text" class="form-control" name="lastname" placeholder="Lastname.." value="<?php if(isset($_POST['lastname'])) echo $_POST['lastname']; ?>" />
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="col-sm-6">
      <div class="form-group">
        <div class="input-group">
          ...
          <input type='text' class="form-control" name='companyName' placeholder='Company Name' value="<?php if(isset($_POST['companyName'])) echo $_POST['companyName']; ?>">
        </div>
      </div>
    </div>
    <div class="col-sm-2">
  ...
  <div class="row">
    ...
    <div class="form-group">
      <div class="input-group">
          ...
          <input type='text' class="form-control" name='domainPart' placeholder="domain.com" value="<?php if(isset($_POST['domainPart'])) echo $_POST['domainPart']; ?>" />
        </div>
      </div>
