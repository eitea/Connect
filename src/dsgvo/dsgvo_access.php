...
<html>
    ...
    <body>
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-4">
                    <?php if ($document_row['logo']) {
                        echo '<img style="max-width:350px;max-height:200px;" src="data:image/jpeg;base64,' . base64_encode($document_row['logo']) . '"/>';
                    } ?>
                </div>
