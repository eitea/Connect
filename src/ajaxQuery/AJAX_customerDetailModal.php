...
<form method="POST">
        ...
        <div id="home<?php echo $x; ?>" class="tab-pane fade <?php if ($activeTab == 'home') {echo 'in active';} ?>">
            ...
            <div class="row">
                <div class="col-md-4 col-md-offset-1">
                    ...
                    <input type="text" class="form-control" name="edit_name" placeholder="Kundenname" value="<?php echo $rowClient['name']; ?>" />
                </div>
                <div class="col-md-3">
                    <label>Kundennummer</label><br>
                    <input type="text" class="form-control" maxlength="12" placeholder="z.B. #KD-123" value="<?php echo $rowClient['clientNumber']; ?>" name="edit_clientNumber" />
                </div>
                <div class="col-md-4">
    ...
    <table class="table table-hover">
        ...
        <tbody>
            <?php
            $resultProc = $conn->query("SELECT name, password, firstname, lastname, documentProcess.id FROM documents, documentProcess, contactPersons WHERE clientID = $x AND personID = contactPersons.id AND documentProcess.docID = documents.id");
                echo $conn->error;
