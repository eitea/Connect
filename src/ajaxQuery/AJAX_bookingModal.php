    ...
    <div class="modal fade editingModal-<?php echo $x ?>" role="dialog" aria-labelledby="mySmallModalLabel">
        <div class="modal-dialog modal-lg modal-content" role="document">
            ...
            <div class="modal-body" style="max-height: 80vh;  overflow-y: auto;">
                ...
                <div class="row">
                    <div class="col-xs-6"><input type='text' class='form-control datetimepicker' maxlength='16' onkeydown='if (event.keyCode == 13) {
                                return false;
                            }' name="editing_time_from_<?php echo $x; ?>" value="<?php echo substr($A, 0, 16); ?>"></div>
                    <div class="col-xs-6"><input type='text' class='form-control datetimepicker' maxlength='16' onkeydown='if (event.keyCode == 13) {
                                return false;}' name='editing_time_to_<?php echo $x; ?>' value="<?php echo substr($B, 0, 16); ?>"></div>
                </div>
                <br>
<?php if ($row['bookingType'] != 'break'): ?>
                    ...
                    <div class="row">
                        <div class="col-xs-6"><input type='text' class='form-control datetimepicker' maxlength='16' onkeydown='if (event.keyCode == 13) {
                                    return false;}' name='editing_chargedtime_from_<?php echo $x; ?>' value="<?php echo substr($A_charged, 0, 16); ?>"></div>
                        <div class="col-xs-6"><input type='text' class='form-control datetimepicker' maxlength='16' onkeydown='if (event.keyCode == 13) {
                                    return false;}' name='editing_chargedtime_to_<?php echo $x; ?>' value="<?php echo substr($B_charged, 0, 16); ?>"></div>
                    </div>
                <?php endif; ?>
                <br>
