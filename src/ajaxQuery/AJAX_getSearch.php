...
if(isset($_POST["german"])) $german = $_POST["german"] == "true";
if(isset($_POST["english"])) $english = $_POST["english"] == "true";
if(isset($_POST["advanced"])) $advanced = $_POST["advanced"] == "true";
...
//TODO: Add Tags?
$routesENG[] = array("name"=>"Request", "url"=>"../social/messages");
$routesGER[] = array("name"=>"Anträge", "url"=>"../social/messages");
...
if($german) $routes = array_merge($routes, $routesGER);
if($english) $routes = array_merge($routes, $routesENG);
