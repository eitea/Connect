...
<?php if ($filterID): ?>
    <ul class="nav nav-tabs">
        <li <?php if ($activeTab == 'log') {
        echo 'class="active"';
    } ?>><a data-toggle="tab" href="#log"><?php echo $lang['HOURS']; ?></a></li>
        <li <?php if ($activeTab == 'vac') {
        echo 'class="active"';
    } ?>><a data-toggle="tab" href="#vac"><?php echo $lang['VACATION']; ?></a></li>
    </ul>

    <div class="tab-content">
        <div id="log" class="tab-pane fade <?php if ($activeTab == 'log') {
        echo 'in active';
    } ?>">
    ...
    <?php echo $lang['ADD']; ?> :<br><br>
        ...
        <div id="vac" class="tab-pane fade <?php if ($activeTab == 'vac') {
                                echo 'in active';
                            } ?>">
            <form method="POST">
                <div class="container-fluid">
