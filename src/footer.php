...
<?php if ($userHasUnansweredOnLoginSurveys) {
    echo "setTimeout(function(){ openSurveyModal() },500)";
} ?>
</script>
<?php // endif;  ?>
...
<script>
    ...
    function onPageLoad() {
            ...
            $(".js-example-basic-single").each(function (i, obj) {
                ...
                if (!elem.data('select2')) {
                    ...
                    elem.on("select2:focus", function (e) {
                        if (!open && $(this).is(':enabled') && !$(this).attr('multiple')) {
                            $(this).select2("open")
                        }
                        ;
                    });
        ...
        $('.datepicker').click(function () {
            ...
            $(this).datetimepicker('show');
            $(this).datetimepicker().on('changeDate', function () {
                this.focus();
            });
        });
